#!/usr/bin/env python3
"""
Borrador de Productos - AgroConecta
...
class ProductCleaner:
    ...
    def delete_all_products(self, confirm=False):
        ...
        print("Iniciando proceso automatizado de eliminación de productos...")
        print("Este script eliminará TODOS los productos del usuario")
        print("MODO AUTOMATICO: Sin confirmaciones")
        print("="*70)
        
        print("\nIniciando eliminación automatizada...")
        ...
        print(f"Se encontraron {len(products)} productos para eliminar")
        
        # Mostrar productos encontrados
        print("\nProductos que serán eliminados:")
        ...
        # Resumen final
        print("\n" + "="*70)
        print("RESUMEN DE ELIMINACIÓN AUTOMATIZADA:")
        print(f"Productos eliminados exitosamente: {success_count}")
...
def simple_delete_all():
    ...
    try:
        ...
        # Confirmación automática (sin solicitar input)
        print(f"\nMODO AUTOMATICO: Procesando {len(products)} productos automáticamente...")
...
def main():
    """Función principal - Eliminación automática con autenticación"""
    print("BORRADOR AUTOMATICO DE PRODUCTOS - AgroConecta")
    print("="*60)
    ...
    try:
        ...
        if login_success:
            ...
            print(f"\nPROCESO COMPLETADO:")
            print(f"   Productos eliminados: {result['success']}")
